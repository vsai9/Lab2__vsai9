...
set_input_transition 0.06 [all_inputs ]
...
set_input_delay -0.819 -clock [get_clocks rclk] [get_ports rinc]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[0]]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[1]]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[2]]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[3]]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[4]]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[5]]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[6]]
set_input_delay -0.819 -clock [get_clocks wclk2x] [get_ports wdata_in[7]]
set_input_delay -0.819 -clock [get_clocks wclk] [get_ports winc]
##########################################################################

############### output delay definitions           ########################
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[0]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[1]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[2]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[3]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[4]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[5]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[6]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rdata[7]]
set_output_delay -0.823 -clock [get_clocks rclk] [get_ports rempty]
set_output_delay -0.823 -clock [get_clocks wclk] [get_ports wfull]
##########################################################################
